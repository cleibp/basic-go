<h1 align="center"> 🚀 GO Básico </h1>

## ✍️ Descrição
Exemplificação da sintaxe geral e básica da Linguagem GO
...
1. Clone:
    ...
    ```bash
    git clone git@github.com:cleibp/basic-go.git
    ```
1. Download:
    ### Download Manual
...
## 👋🏽 DEMO
[REPLIT](https://replit.com/@cleibp/Basic-Go) 
